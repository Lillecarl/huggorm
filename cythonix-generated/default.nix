...
python3Packages.buildPythonPackage {
  ...
  env.PXD_FILE = "${cythonix-bindings.src}/cythonix_bindings/c_mock_store.pxd ${cythonix-bindings.src}/cythonix_bindings/c_eval.pxd ${cythonix-bindings.src}/cythonix_bindings/c_path.pxd";
