...
can only be told so once: `ruff.toml` exempts `spike-idl/decl/` from
the three rules that fire on the things which make a file a
declaration rather than a program (`F821`, `UP037`, `PIE790`). The
machinery next door is exempt from nothing.
